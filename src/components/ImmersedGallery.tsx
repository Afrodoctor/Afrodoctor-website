...
const IMMERSED_IMAGES: ImageItem[] = [
  { src: '/images/immersed/DSC_0082.JPG', alt: 'Immersed training - group shot', caption: 'Immersed training: digital skills session' },
  { src: '/images/immersed/DSC_0103.JPG', alt: 'Participant using mobile app', caption: 'Hands-on Afrodoctor app training' },
  { src: '/images/immersed/DSC_0105.JPG', alt: 'Instructor demonstrating', caption: 'Instructor demonstrating telehealth features' },
  { src: '/images/immersed/DSC_0113.JPG', alt: 'Students with laptops', caption: 'Digital skills session participants' },
  { src: '/images/immersed/DSC_0114.JPG', alt: 'Accessible training for persons with disabilities', caption: 'Inclusive training — persons with disabilities' },
  { src: '/images/immersed/DSC_0128.JPG', alt: 'Group discussion', caption: 'Group mentorship & discussion' },
  { src: '/images/immersed/DSC_0132.JPG', alt: 'Girl using phone', caption: 'Young women learning telehealth tools' },
  { src: '/images/immersed/DSC_0133.JPG', alt: 'Certificate presentation', caption: 'Graduation & certificates' },
  { src: '/images/immersed/DSC_0138.JPG', alt: 'Mentor advising participant', caption: 'Mentorship session' },
  { src: '/images/immersed/DSC_0139.JPG', alt: 'Demo of Afrodoctor HMS', caption: 'Afrodoctor HMS demo' },
  { src: '/images/immersed/DSC_0140.JPG', alt: 'Community outreach', caption: 'Community health champion outreach' },
  { src: '/images/immersed/DSC_0251.JPG', alt: 'Group photograph', caption: 'Immersed cohort photo' },
  { src: '/images/immersed/IMG1.jpg', alt: 'Training session 1' },
  { src: '/images/immersed/IMG2.jpg', alt: 'Training session 2' },
  { src: '/images/immersed/IMG3.jpg', alt: 'Training session 3' },
  { src: '/images/immersed/IMG4.jpg', alt: 'Training session 4' },
  { src: '/images/immersed/IMG5.jpg', alt: 'Training session 5' },
];
