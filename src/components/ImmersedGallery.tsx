...
const IMMERSED_IMAGES: ImageItem[] = [
  { src: '/images/immersed/DSC_0082.JPG', alt: 'Immersed training - group shot'},
  { src: '/images/immersed/DSC_0103.JPG', alt: 'Participant using mobile app'},
  { src: '/images/immersed/DSC_0105.JPG', alt: 'Instructor demonstrating'},
  { src: '/images/immersed/DSC_0113.JPG', alt: 'Students with laptops'},
  { src: '/images/immersed/DSC_0114.JPG', alt: 'Accessible training for persons with disabilities' },
  { src: '/images/immersed/DSC_0128.JPG', alt: 'Group discussion'},
  { src: '/images/immersed/DSC_0132.JPG', alt: 'Girl using phone'},
  { src: '/images/immersed/DSC_0133.JPG', alt: 'Certificate presentation'},
  { src: '/images/immersed/DSC_0138.JPG', alt: 'Mentor advising participant' },
  { src: '/images/immersed/DSC_0139.JPG', alt: 'Demo of Afrodoctor HMS' },
  { src: '/images/immersed/DSC_0140.JPG', alt: 'Community outreach' },
  { src: '/images/immersed/DSC_0251.JPG', alt: 'Group photograph'},
